...
# Merge pdfs
pdftk ./Coversheet/coversheet.pdf ./AccuracyTracker/AccuracyTracker.pdf ./AccuracyGrapher/AccuracyGrapher.pdf ./Worksheet/worksheet.pdf cat output CCVCwords.pdf
